...
const Why_Us = () => {
  return (
    <div className='relative'>
        <About_Us_SVG_BG/>
        <div className="">
        <div className="lg:absolute lg:left-1/2 transform lg:-translate-x-1/2 lg:bottom-[30px] justify-items-center p-5  xl:bottom-[100px] 2xl:bottom-[50px] lg:w-10/12 w-full z-10">
