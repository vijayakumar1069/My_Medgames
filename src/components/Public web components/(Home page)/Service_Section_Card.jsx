...
const Service_Section_Card = ({ data }) => {
  ...
  return (
    <div className="group bg-transparent font-Manrope  cursor-pointer text-black rounded-lg rounded-br-[70px] relative shadow-lg p-4 w-full max-w-xl  mx-auto mb-4">
