...
const Svg_Bg = () => {
  return (
    <div className="relative bg-[#E9f8F3] py-8">
      <div className="relative flex flex-col md:flex-row items-center justify-between w-full max-w-7xl mx-auto px-4 lg:px-16 h-auto md:h-[400px] space-y-16 md:space-y-0">
        {/* Left Image */}
