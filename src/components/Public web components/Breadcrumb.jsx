...
const Breadcrumb = ({ items = [], headingTextColor }) => {
  return (
    <nav 
      className="flex items-center space-x-2 p-1 flex-wrap space-y-2 md:space-y-0 justify-center text-gray-700" 
      aria-label="Breadcrumb"
    >
      <Link 
        href="/" 
        className={`flex items-center mt-2 md:mt-0 ${headingTextColor || "text-white"} hover:underline`}
      >
