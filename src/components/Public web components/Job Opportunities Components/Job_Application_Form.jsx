...
const formSchema = z.object({
  ...
  resume: z.instanceof(File).refine((file) => file.size <= 3 * 1024 * 1024, {
...
const Job_Application_Form = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full h-full bg-white py-5">
      <div className="relative w-full flex flex-col max-w-5xl md:flex-row space-y-8 md:space-y-0 md:space-x-8 bg-white shadow-lg rounded-xl p-6">
        {/* Image Section */}
        ...
        <div className="w-full md:w-1/2 flex flex-col space-y-4">
          ...
          <Form {...form}>
            <form
              ...
              className="space-y-6 px-3 md:px-0"
            >
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="John"
                          {...field}
                          className=" job_application_style flex-1 "
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        className=" job_application_style "
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="advertisement representative (Volunteer)">
                            Advertisement Representative(Volunteer){" "}
                          </SelectItem>
              ...
              <div className="flex md:space-x-4 md:space-y-0 justify-between md:flex-row flex-col space-y-3 w-full">
                <Button
                  ...
                  disabled={loading}
                  onClick={onReset}
                  className="w-full rounded-md bg-gray-400 hover:bg-red-400 px-3 py-3 text-white"
                >
                  Reset Form
                </Button>
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#4F9F76] text-white hover:bg-[#376F5F]"
                >
