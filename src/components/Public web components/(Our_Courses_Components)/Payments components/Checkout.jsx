...
import {
  add_payment,
  paymentclientSecret,
} from "@/app/actions/payment_functions";
          ...
          confirmParams: {
            return_url: `${
              process.env.NEXT_PUBLIC_ENVIRONMENT === "development"
                ...
                : "https://my-medgames.vercel.app/payment-success"
            }`,
          },
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex space-x-6 justify-end ">
              <Button
                type="button"
                onClick={handleback}
                className="bg-[#4F9F76]/40 text-black px-4 py-2 rounded-md hover:bg-transparent hover:text-[#4F9F76] drop-shadow-lg"
              >
                Back
              </Button>
